...
4. Required environment variables:
   ...
   - Make sure the service account key you created has Cloud Messaging permissions (Firebase console → Project settings → Service accounts → create key for “Firebase Admin SDK”).
